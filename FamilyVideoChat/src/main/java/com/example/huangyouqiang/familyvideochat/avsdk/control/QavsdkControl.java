...
import com.example.huangyouqiang.familyvideochat.avsdk.MemberInfo;
import com.example.huangyouqiang.familyvideochat.avsdk.MultiVideoMembersControlUI;
...
public class QavsdkControl {
	 ...
	 *            用户身份的校验信息
	 */
	public int startContext(String identifier, String usersig, AVChatStartContextCallBack callback) {
		if (mAVContextControl == null)
			return DemoConstants.DEMO_ERROR_NULL_POINTER;
		return mAVContextControl.startContext(identifier, usersig,callback);
	}
