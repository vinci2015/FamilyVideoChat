...
public class CreateRoomActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.create_room:
			...
			{
				Util.auth_bits = AVRoom.AUTH_BITS_CREATE_ROOM | AVRoom.AUTH_BITS_JOIN_ROOM | AVRoom.AUTH_BITS_RECV_SCREEN_VIDEO;
				...
				if( isAuthVideoSend.isChecked() )
					Util.auth_bits |= AVRoom.AUTH_BITS_SEND_CAMERA_VIDEO;
				if( isAuthVideoRev.isChecked() )
					Util.auth_bits |= AVRoom.AUTH_BITS_RECV_CAMERA_VIDEO;
			}
