...
*/
	...
	private void onMemberChange(int eventid, String[] updateList) {
		...
		QavsdkControl qavsdk = AVManager.getInstance(AndroidApplication.getContext()).getqavsdkControl();
	...
	void enterRoom(int relationId, String roomRole) {
		...
		AVRoom.EnterRoomParam enterRoomParam = new AVRoomMulti.EnterRoomParam(relationId, Util.auth_bits, authBuffer, roomRole, audioCat,true);
		// create room
